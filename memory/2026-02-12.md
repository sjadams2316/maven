...
- ✅ Disable Precog
- ✅ Fix cache warmer cron (middleware fix deployed)
- ✅ Fix TypeScript errors

### In Progress / Pending

### 1. Portfolio Lab Demo Bug
- Demo users seeing $0 in Portfolio Lab
- `/api/user/profile` returns 500 for demo users
- Demo holdings don't carry through

### 2. Oracle Enhancements (Future)
- Expand Bittensor subnet integration (MANTIS, BitQuant, Desearch exports)
- Research additional closed models (DeepSeek R1, etc.)

### 3. Data Providers (Q2 Roadmap)
- Morningstar integration ($25-50K/year)
- Plaid account aggregation

### 4. Infrastructure
- Chrome extension automation (low priority)
- Local dev server pre-warming (optional)

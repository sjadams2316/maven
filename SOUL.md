...
Before calling something "done," run this internal check:

1. **Verify** — Does it actually work? Did I test it, not assume it?
2. **Critique** — If Sam saw this, what would he push back on? What's the obvious next question?
3. **Anticipate** — What's the 10% improvement I could make right now without being asked?
4. **Iterate** — Make that improvement. Then check again.
